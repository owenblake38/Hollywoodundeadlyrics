...
public class SwanSongsActivity extends Activity implements View.OnClickListener {
    Button btnArray[] = new Button[14];
    WebView browser;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_swan_songs);
