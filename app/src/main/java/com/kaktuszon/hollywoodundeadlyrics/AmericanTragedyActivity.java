...
public class AmericanTragedyActivity extends Activity implements View.OnClickListener {
    Button btnArray[] = new Button[18]; //Create an array of all buttons for the songs
    WebView browser; //A webview to display the right songlyrics

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_american_tragedy);
